 ...
 */
export const __storeToDerived = new WeakMap<Store<unknown>, Set<Derived<unknown>>>();
export const __derivedToStore = new WeakMap<Derived<unknown>, Set<Store<unknown>>>();
...
// this function is to get all the derived values to recompute
function __flush_internals(relatedValues: Set<Derived<unknown>>) {
